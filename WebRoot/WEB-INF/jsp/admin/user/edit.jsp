		...
		<div class="user_left">
			...
			<div class="layui-form-item" style="margin-top: 20px;">
				...
				<div class="layui-input-block">
					<input type="text" name="nickName" value="${user.nickName}" maxlength="12"
			...
			<div class="layui-form-item" pane="">
				...
				<div class="layui-input-block">
					<input type="radio" name="sex" value="男" title="男"
						<c:if test="${user.sex == '男' || user.sex == null}">checked=""</c:if>> <input
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<div class="layui-upload">
						<button type="button" class="layui-btn layui-btn-danger" id="uploadBtn">上传头像</button>
						<div class="layui-upload-list">
							<img class="layui-upload-img" id="image"
								style="width: 100px; height: 100px;"
								<c:if test="${user.headImg != null}">src="${ctx}${user.headImg}"</c:if>
								<c:if test="${user.headImg == null}">src="${ctx}/res/images/default.jpg"</c:if>
								> <input type="hidden"
								value="<c:if test="${user.headImg != null}">${user.headImg}</c:if>"
								value="<c:if test="${user.headImg == null}">/res/images/default.jpg</c:if>"
	...
	<script>
		layui.use([ 'form', 'upload' ], function() {
			...
			var uploadInst = upload
					.render({
						elem : '#uploadBtn',
						url : '${ctx}/admin/user/uploadHeadImg',
						before : function(obj) {
							//预读本地文件示例，不支持ie8
