...
<body>
	...
	<div class="layui-carousel" id="banner">
		<div carousel-item="">
			<div>
				<img src="${ctx}/res/images/1.jpg">
			</div>
			<div>
				<img src="${ctx}/res/images/2.jpg">
			</div>
			<div>
				<img src="${ctx}/res/images/4.jpg">
			</div>
			<div>
				<img src="${ctx}/res/images/5.jpg">
			</div>
			<div>
				<img src="${ctx}/res/images/6.jpg">
			</div>
			<div>
				<img src="${ctx}/res/images/7.jpg">
			</div>
		</div>
	</div>
