...
public class OrdersInfo extends Page {
	private String id;
	...
	public String getRvalContent() {
		return rvalContent;
	}

	public void setRvalContent(String rvalContent) {
		this.rvalContent = rvalContent == null ? null : rvalContent.trim();
	}
